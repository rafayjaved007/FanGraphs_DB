...
for player_url, player in zip(urls, players):
    try:
        ...
        for date, team, opp, gs, o_swing_percentage, z_swing_percentage, swing_percentage, o_contact_percentage,\
                z_contact_percentage, contact_percentage, zone_percentage, f_strike_percentage, swstr_percentage\
                in itertools.zip_longest(date_list[1:s], team_list, opp_list, gs_list,o_swing_percentage_list,
                                         z_swing_percentage_list, swing_percentage_list, o_contact_percentage_list,
                                         z_contact_percentage_list, contact_percentage_list, zone_percentage_list,
                                         f_strike_percentage_list, swstr_percentage_list):
